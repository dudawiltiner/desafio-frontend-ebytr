        ...
        <div className="flex flex-col items-center justify-center max-w-md p-12 rounded-lg shadow-xl shadow-white">
          ...
          <form data-testid="form-login" onSubmit={ auth } className="w-full mt-6 space-y-10">
            <div className="py-2 space-y-2 border-b border-brown-color">
              ...
              <input name="email" onChange={ ({ target }) => setEmail(target.value) } required className="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" type="text" placeholder="nome@nome.com" />
            </div>
            <div className="py-2 border-b border-brown-color">
              <p className="text-md ext-gray-800">Digite a sua senha:</p>
              <input name="password" onChange={ ({ target }) => setPassword(target.value) } required className="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" type="password" placeholder="•••••••••" />
            </div>
